...
namespace SeveranceStrategy.Game.Kinematics
{
    public sealed class CameraManager : MonoBehaviour, IDragHandler
    {
        ...
        private void Update()
        {
            ...
            // Cemera movement:
            Vector2 input = new(InputManager.GetAxis(Keybinds.MoveLeft.Value, Keybinds.MoveRight.Value), InputManager.GetAxis(Keybinds.MoveUp.Value, Keybinds.MoveDown.Value));
